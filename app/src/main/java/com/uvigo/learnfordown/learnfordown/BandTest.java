...
import com.uvigo.learnfordown.learnfordown.util.BinaryDistance;
...
import com.uvigo.learnfordown.learnfordown.util.EuclideanDistance;
import com.uvigo.learnfordown.learnfordown.dtw.TimeWarpInfo;
import com.uvigo.learnfordown.learnfordown.dtw.LinearWindow;
...
public class BandTest
{
      ...
      public static void main(String[] args)
      {
         ...
         else
         {
            ...
            final TimeWarpInfo info = com.uvigo.learnfordown.learnfordown.dtw.DTW.getWarpInfoBetween(tsI, tsJ, new LinearWindow(tsI, tsJ, Integer.parseInt(args[2])), distFn);
