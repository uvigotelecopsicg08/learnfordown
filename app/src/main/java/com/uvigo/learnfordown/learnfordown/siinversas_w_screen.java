...
public class siinversas_w_screen extends AppCompatActivity {
    TextView titulo;
    @Override
    ...
    public void BackArrow (View v){
        Intent intent1 = new Intent(siinversas_w_screen.this, menu_write_screen.class);
        startActivity(intent1);
    }
    public void goHome (View v){
        Intent intent1 = new Intent(siinversas_w_screen.this, home_screen.class);
        startActivity(intent1);
    }
